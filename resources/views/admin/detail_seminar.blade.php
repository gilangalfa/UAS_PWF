<x-admin.layout>
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12 mb-12">
        <div class="bg-white dark:bg-[#FFE6E6] relative overflow-hidden shadow-lg border-2">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4 ">

                <h3 class="w-full text-black text-3xl font-semibold ">Tabel Peserta</h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <thead class="text-xs text-black uppercase bg-gray-50 dark:bg-[#FFE6E6] dark:text-gray-600">
                        <tr>
                    ...
                    <tbody>
                        @foreach ($participants as $participant)
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 text-gray-900 whitespace-nowrap dark:text-black">{{$participant->name}}</th>
